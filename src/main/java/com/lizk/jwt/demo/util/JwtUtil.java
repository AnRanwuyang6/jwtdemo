package com.lizk.jwt.demo.util;
...
public class JwtUtil {
    //密钥
    public static final String KEY = "e-lizk";
    //签发人
    public static final String issuer = "lizk";
    ...
    public static boolean checkToken(String jwtToken, ObjectMapper objectMapper) throws Exception {
        ...
        String pernr = claims.getSubject();
        /*
        ...
        System.out.println("======== token的过期时间：" + df.format(expiration));
        return true;
    }
